...
util_methods_1 = utils(delta, P,R,C,EPISODE_LENGTH,N_STATES,N_ACTIONS,actions,CONSTRAINT,C_b)
...
util_methods_1 = utils(delta, P,R,C,EPISODE_LENGTH,N_STATES,N_ACTIONS,actions,C_b,C_b)
...
pickle.dump([NUMBER_SIMULATIONS, NUMBER_EPISODES, P, R, C, CONSTRAINT, N_STATES, N_ACTIONS, actions, EPISODE_LENGTH, delta], f)
f.close()
